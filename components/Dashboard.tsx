...
const IoTDashboard = () => {
  ...
  // Mock NPK Data
  const npkData = [
    { label: t.nitrogen, value: '45 mg/kg', status: t.iotStatus.good, color: 'text-green-500', bg: 'bg-green-50 dark:bg-green-900/20' },
    { label: t.phosphorus, value: '12 mg/kg', status: t.iotStatus.low, color: 'text-yellow-500', bg: 'bg-yellow-50 dark:bg-yellow-900/20' },
    { label: t.potassium, value: '180 mg/kg', status: t.iotStatus.high, color: 'text-rose-500', bg: 'bg-rose-50 dark:bg-rose-900/20' },
  ];
  ...
  return (
    <div className="min-h-screen bg-palette-cream dark:bg-[#161F1A] pt-28 pb-12 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <motion.div 
          ...
          className="mb-12"
        >
          {/* Increased margin-bottom from mb-2 to mb-6 for better spacing */}
          <h2 className="text-3xl md:text-5xl font-bold text-palette-slate dark:text-white mb-6">{t.serviceIoT}</h2>
          <p className="text-palette-copper dark:text-gray-400 text-lg">{t.serviceIoTDesc}</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          ...
          <motion.div 
             ...
             className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-palette-petal/30 dark:border-gray-700"
          >
             <div className="flex items-center justify-between mb-6">
               ...
               <span className="px-2 py-1 rounded bg-green-100 text-green-700 text-xs font-bold uppercase">{t.active}</span>
             </div>
          ...
          <div className="space-y-8">
             ...
             >
               <h3 className="font-bold text-lg text-gray-900 dark:text-white mb-6 flex items-center gap-2">
                 <Activity className="w-5 h-5 text-palette-sage dark:text-emerald-500" />
                 {t.npkDashboard}
               </h3>
             ...
             >
                {otherSensors.map((sensor, idx) => (
                   <div key={idx} className="bg-white dark:bg-gray-800 p-4 rounded-2xl border border-palette-petal/30 dark:border-gray-700 shadow-sm flex flex-col items-center justify-center">
